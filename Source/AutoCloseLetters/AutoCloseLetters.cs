...
namespace AutoCloseLetters
{
    ...
    public static class AutoCloseLetters_Patch
    {
        ...
        {
            Find.LetterStack.LettersListForReading.Where(x => x.arrivalTick < Find.TickManager.TicksGame - (60000 * Prefs.AutosaveIntervalDays) && x.disappearAtTick < 0).ToList().ForEach(Remove);
        }
